...
export interface WarehouseLocationSeedData {
  // Rack information
  rack_id: string;
  aisle_code: string;
  rack_name: string;
...
export class WarehouseLocationSeeder extends BaseSeed<WarehouseLocationSeedData> {
  ...
  validateRecord(record: WarehouseLocationSeedData): boolean {
  ...
  async transformRecord(record: WarehouseLocationSeedData): Promise<any> {
  ...
  async findExistingRecord(record: WarehouseLocationSeedData): Promise<any> {
