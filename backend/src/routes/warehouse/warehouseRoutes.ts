  ...
  try {
    ...
    const warehouse = await prisma.warehouses.create({
      data: {
        ...
        storage_capacity: storage_capacity ? parseInt(storage_capacity) : null,
        temperature_controlled: temperature_controlled || false,
        min_temperature: min_temperature ? parseFloat(min_temperature) : null,
        max_temperature: max_temperature ? parseFloat(max_temperature) : null,
