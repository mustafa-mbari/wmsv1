      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <Card className="bg-gradient-to-r from-purple-50 to-purple-100 dark:from-purple-950/50 dark:to-purple-900/30 border-purple-200 dark:border-purple-800">
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-purple-600 dark:text-purple-400 text-sm font-medium">Attributes</p>
      ...
      <Card className="shadow-lg border-0 bg-card">
        ...
        <CardContent className="p-12">
          <div className="text-center space-y-4">
            ...
            <div className="space-y-2">
              <h3 className="text-lg font-medium">No Attribute Options Found</h3>
              <p className="text-muted-foreground max-w-md mx-auto">
                This page will be implemented soon to manage attribute options like sizes, colors, and other product variations.
              </p>
            </div>
            {canPerformAdminActions && (
              <div className="pt-4">
