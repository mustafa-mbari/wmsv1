          ...
          <div className="space-y-2">
            ...
            <p className="text-muted-foreground max-w-2xl">
              {canPerformAdminActions
                ...
                : "View system roles and their details (read-only access)"
              }
            </p>
          </div>
          ...
          <div className="flex items-start space-x-3">
            ...
            <div className="flex-1">
              ...
              <p className="mt-1 text-sm text-amber-800 dark:text-amber-200 leading-relaxed">
                You have view-only access to roles. To create, edit, or delete roles, contact your system administrator.
              </p>
            </div>
          </div>
        </div>
